    ...
    <el-container class="app-body">
      <el-aside width="200px" class="app-aside">
        ...
        <el-menu :default-active="activeMenu" router>
          ...
          <el-menu-item index="/student/graph">
...
<script>
import { ChatDotSquare, Trophy, Connection, Setting, SwitchButton, Bell } from '@element-plus/icons-vue'
...
import CareerPathPanel from '../components/CareerPathPanel.vue'

export default {
  name: 'StudentLayout',
  components: { SettingsDrawer, ZhihuSearchPanel, DomainSwitcher, CareerPathPanel },
  data() {
